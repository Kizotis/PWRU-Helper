...
| E7.S4 → S8 | (S4 in progress) | — | — | Paused state + frozen heartbeat on both surfaces, toast arbitration → LIVE/read-once/overlay copy incl. "Cancel read" → pending-row render test → About "Translation engines" block (+ cache privacy, "Clear cache") → README/About copy. |
