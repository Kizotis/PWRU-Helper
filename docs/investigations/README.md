...
| E7.S6 → S8 | (S6 in progress) | — | — | Pending-row render tests → About "Translation engines" block (+ cache privacy, "Clear cache") → README/About copy. Then E8 (Bergamot): S1 spike (go, E8-d) → S2 … S7. |
