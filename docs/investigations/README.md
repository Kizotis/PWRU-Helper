...
| E7.S5 → S8 | (S5 in progress) | — | — | LIVE/read-once/overlay copy incl. "Cancel read" (A8) → pending-row render test → About "Translation engines" block (+ cache privacy, "Clear cache") → README/About copy. Then E8 (Bergamot) — story files being written. |
