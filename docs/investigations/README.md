...
| E7.S7 About block + Clear cache | `393940e` | (review) | → 1211 | About restructured (engines in use · keys · offline slot without a button until E8 · saved translations + atomic `Clear cache`); status line = the chain's own predicate; transient feedback on its own line. |
| E7.S8 | — | — | — | README/About copy. Then E8 (Bergamot): S1 spike (go, E8-d) → S2 … S7. |
